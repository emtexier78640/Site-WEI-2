...
# complète .env.local : JWT_SECRET, ADMIN_USERNAME, ADMIN_PASSWORD_HASH
...
- **Inscription** : limitée par IP, validation stricte de tous les champs (identifiant `[a-z0-9._-]{3,32}`, mot de passe 8–128 caractères, énumérations pour statut / voiture / covoiturage).
